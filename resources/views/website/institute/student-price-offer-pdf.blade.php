...
<body>
    ...
    <div class="footer" dir="ltr">
        <a style="text-decoration: none" href="https://www.snapchat.com/add/clas_sat"><img width="40px" src="{{$data['base_url'].'/storage/icons/snapchat.png'}}" alt=""> </a>&nbsp;&nbsp;
        ...
        <a style="text-decoration: none" href="https://www.instagram.com/Clas_sat/"><img width="40px" src="{{$data['base_url'].'/storage/icons/instegram.png'}}" alt=""> </a>
