        ...
        <div class="container-fluid">
            <div class="row px-xl-5 align-items-center">
                <div class="col-lg-6 py-5 text-right">
                    <h1 style="font-size: 70px;" class="text-white text-md-right text-center font-weight-bold mb-4">سياسة الاستردات</h1>
                    <div class="row">
                        <div class="col-md-5">
                            <a href="#refund-policy"><button type="submit" class="btn w-100 rounded-10 bg-white text-center text-main-color">اقراء المزيد</button></a>
                        </div>
                    </div>
                </div>
