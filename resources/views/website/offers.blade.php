        ...
        <div class="container-fluid">
          ...
          <div class="row px-xl-5">
            <div class="col-12">
              <div class="heading-institutes">
                ...
                <p class="mb-5">نسعى من خلال عقودنا واتفاقياتنا مع المعاهد، والجامعات، والمؤسسات الأكاديمية إلى رفع مستوى التعاون، وخلق بيئة تنافسية</p>
              </div>
            </div>
          </div>
          <!-- ./Section Heading -->
          ...
          <div class="row px-xl-4">
            @if(isset($offers[0]))
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <h6 class="card-title"><a target="_blank" href="{{route('website.institute' , [$offer->institute->id, $offer->institute->slug , $offer->slug])}}" class="text-main-color">{{$offer->name_ar}} </a></h6>
                            ...
                            <div class="card-footer bg-white overflow-hidden">
                                <del class="text-muted del">{{round($offer->coursesPricePerWeek->price)}} ر.س / أسبوع </del>
                                <span class="float-left text-main-color">{{round($offer->coursesPricePerWeek->price*(1-$offer->discount)) }} ر.س / أسبوع </span>
                            </div>
                            <!-- ./Course Price -->
                        </div>
                    </div>
                @endforeach
            @else
                <div class="alert alert-danger text-center mt-5 h2 col-12">
                    لا يوجد عروض 
                </div>
            @endif
