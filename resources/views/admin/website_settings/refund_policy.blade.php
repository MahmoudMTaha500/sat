                ...
                <div class="col-lg-10">
                    <div class="card" style="zoom: 1;">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form" action="{{route('website_settings.update_refund_policy')}}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea dir="rtl" name="refund_policy" id="ckeditor" cols="30" rows="20" class="ckeditor"> {{$refund_policy}} </textarea>
                                                </div>
                                            </div>
                                        </div>
