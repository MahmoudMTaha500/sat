                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تصنيفات التاشيرات</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li>
                                        <a class="btn btn-sm btn-success box-shadow-2 round btn-min-width pull-right" href="{{route('visa_categories.create')}}"> <i class="ft-plus ft-md"></i> اضافة تصنيف جديد</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <table id="recent-orders" class="table table-hover table-xl mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">عدد التاشيرات</th>
