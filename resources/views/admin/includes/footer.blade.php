...
<footer class="footer footer-static footer-light navbar-border navbar-shadow">
  ...
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/chart.min.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/echarts/echarts.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/ui/headroom.min.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/chartist.min.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/raphael-min.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/vendors/js/charts/morris.min.js" type="text/javascript"></script>
  ...
  <script src="{{url('/admin')}}/app-assets/vendors/js/forms/select/selectize.min.js" type="text/javascript"></script>
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="{{url('/admin')}}/app-assets/js/scripts/pages/dashboard-crypto.js" type="text/javascript"></script>
  <script src="{{url('/admin')}}/app-assets/js/scripts/pages/dashboard-ecommerce.js" type="text/javascript"></script>
  ...
  <script src="{{url('/admin')}}/app-assets/js/scripts/forms/select/form-selectize.js" type="text/javascript"></script>
