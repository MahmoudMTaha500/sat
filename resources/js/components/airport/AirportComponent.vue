                        ...
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            <tbody>
                                <tr v-for="airport in airports.data" :key="airport.id">
                                    ...
                                    <td class="text-truncate">{{airport.institute.country.name_ar}}</td>
                                    <td class="text-truncate">{{airport.institute.city.name_ar}}</td>
                                    ...
                                    <td class="text-truncate">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a v-if="delete_pre" :href="dahsboard_url+'/airports/'+'delete/'+airport.id">
