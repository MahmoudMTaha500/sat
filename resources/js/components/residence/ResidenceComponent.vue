                        ...
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            <tbody>
                                <tr v-for="residence in residences.data" :key="residence.id">
                                    ...
                                    <td class="text-truncate">{{residence.institute.country.name_ar}}</td>
                                    <td class="text-truncate">{{residence.institute.city.name_ar}}</td>
                                    ...
                                    <td class="text-truncate">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a v-if="delete_pre" :href="dahsboard_url+'/residences/'+'delete/'+residence.id">
                                                <button type="button" class="btn btn-danger btn-sm round" onclick="return confirm('هل انت متاكد من حذف هذا المعهد')">حذف</button>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
