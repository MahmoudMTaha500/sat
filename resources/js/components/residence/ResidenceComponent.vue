                          ...
                          <tbody>
                            ...
                            <tr v-for="residence in residences.data" :key="residence.id">
                              ...
                              <td class="text-truncate">
                                ...
                                <a v-if="edit" :href="dahsboard_url+'/residences/'+'edit/'+residence.id"><button type="button" class="btn btn-sm btn-outline-primary round">تعديل</button></a>
                                <a  v-if="delete_pre" :href="dahsboard_url+'/residences/'+'delete/'+residence.id"><button type="button" class="btn btn-sm btn-outline-danger round"  onclick="return confirm('هل انت متاكد من حذف هذا المعهد')">حذف</button></a>
                              </td>
                            </tr>
