                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                              <table id="recent-orders" class="table table-hover table-xl mb-0">
                                ...
                                <input type="checkbox" id="checkbox"       v-model="course.approvment"   
                                @change="updateApprovment" @click="getCourse_id(course.id)" > 
...
export default {
    ...
    methods:{
            ...
            //   alert(this.name_ar);
             ...
             { params:{ 'institute_id':this.selected_institute,
            ...
            updateApprovment:function(e){
                          ...
                          axios.post(this.dahsboard_url+'/updateAprovement', {"course_id":  this.course_id ,"approvment":newValue},
