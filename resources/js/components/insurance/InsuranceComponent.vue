                        ...
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            <tbody>
                                <tr v-for="insurance in insurances.data" :key="insurance.id">
                                    ...
                                    <td class="text-truncate">{{insurance.institute.country.name_ar}}</td>
                                    <td class="text-truncate">{{insurance.institute.city.name_ar}}</td>
                                    ...
                                    <td class="text-truncate">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a v-if="delete_pre" :href="dahsboard_url+'/insurances/'+'delete/'+insurance.id">
