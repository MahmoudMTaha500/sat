...
class simpleVisaController extends Controller
{
    ...
    public function create()
    {
        ...
        $page_identity = [
            ...
            'meta_description' => 'كلاسات منصة إلكترونية رائدة في تقديم الخدمات الأكاديمية والتعليمية بأفضل المعاهد والمؤسسات الدولية للطلبة الدوليين، و توفير دورات اللغة الإنجليزية الأكاديمية المتخصصة، اقراء  طلب تأشيرة',
            'page_name' => 'visa',
        ];
