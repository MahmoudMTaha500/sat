        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                <div class="col-md-5 col-12">
                    <img src="<?php echo e(asset('website')); ?>/imgs/logo-white.png" alt="Classat Logo" class="img-fluid" />
                ...
                <div class="col-md-2 col-6 mt-3 mt-md-0">
                    ...
                    <ul class="p-0">
                        <li><a href="<?php echo e(route('website.institutes')); ?>" class="text-white">المعاهد</a></li>
                        <li><a href="<?php echo e(route('order-visa.create')); ?>" class="text-white">طلب تأشيرة</a></li>
                        <li><a href="<?php echo e(route('website.offers')); ?>" class="text-white">العروض</a></li>
                        <li><a href="<?php echo e(route('website.articles')); ?>" class="text-white">المقالات</a></li>
                    </ul>
                </div>
                <div class="col-md-2 col-6 mt-3 mt-md-0">
                    <h6 class="text-secondary-color">الشركة</h6>
                    <ul class="p-0">
                        <li><a href="<?php echo e(route('website.about.us')); ?>" class="text-white">عن الشركة</a></li>
                        <li><a href="<?php echo e(route('website.contact.us')); ?>" class="text-white">اتصل بنا</a></li>
                        <li><a href="<?php echo e(route('website.terms_conditions')); ?>" class="text-white">الشروط والأحكام</a></li>
                        <li><a href="<?php echo e(route('website.refund_policy')); ?>" class="text-white">شروط الاسترداد</a></li>
                    </ul>
                </div>
...
<div class="support position-fixed p-3 d-md-none d-block">
    ...
    <?php if($page_identity['page_name'] != 'home'): ?>
        <script src="<?php echo e(asset('website')); ?>/js/global.js"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('website')); ?>/js/home-scripts.js"></script>
...
<?php /**PATH C:\wamp64\www\classat_laravel\resources\views/website/includes/footer.blade.php ENDPATH**/ ?>